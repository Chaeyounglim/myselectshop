...
class ProductServiceTest {
    ...
    void test1() {
        ...
        // when
        ProductResponseDto result = productService.updateProduct(requestMyPriceDto, productId);
    ...
    void test2() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            productService.updateProduct(requestMyPriceDto, productId);
        });

        // then
        assertEquals(
                "유효하지 않은 관심 가격입니다. 최소 " +ProductService.MIN_MY_PRICE + "원 이상이여야 합니다.",
